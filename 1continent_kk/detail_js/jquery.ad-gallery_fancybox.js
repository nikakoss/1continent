...
(function ($) {
    $.fn.adGallery = function (options) {
        var defaults = {
            ...
            effect: 'resize', // or 'slide-vert', 'fade', or 'resize', 'none', false
    ...
    AdGallery.prototype = {
        ...
        findImages: function () {
            ...
            function (i) {
                ...
                context.images[i] = {
                    thumb: thumb.attr('src'), image: image, error: false,
        ...
        _showWhenLoaded: function (index, callback) {
            if (this.images[index]) {
                ...
                link.attr('rel', 'shadowbox[imggal]');
                //link.attr('href', '#');
                img_container.addClass('ad-image');
                link.append(img);
                img_container.append(link);
                img.attr('src', image.image);
                img.addClass('wmImage');
                ...
                $('#hidden_gal > a').addClass('fancybox');
                var glink = image.image;
                var asd = $('#hidden_gal > a[href="'+glink+'"]').removeClass('fancybox');
                
                
                /*///////*/
                
                
                //WMWater = '/templates/kamenka_tagan/img/watermark.png';
                //WMOpacity = 0.3;
                //WMClass = 'wmImage';
                //WMPosX = '50%';
                //WMPosY = '50%';
