...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/TR/xlink">
    ...
    <xsl:variable name="current_catalog" select=".//page[@parentId = '0' and @is-active = '1']/@alt-name"/>
    <xsl:variable name="is-home" select="result[@module='content' and @method='content' and page/@is-default = '1']"/>
    
    <xsl:variable name="global_parameters" select="document('upage://home/global_parameters')//group[@name = 'glavnaya_stranica']"/>
    <xsl:variable name="global_parameters_kk" select="document('upage://krasnodar/home/global_parameters/')//group[@name = 'glavnaya_stranica']"/>
